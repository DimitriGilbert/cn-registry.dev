...
export default function ComponentAnalyticsPage({
	...
	const { data: analytics, isLoading } = useQuery(
		trpc.analytics.getComponentAnalytics.queryOptions({
			componentId: id,
			period: "month",
		}),
	);
	...
	if (isLoading || !component || !analytics) {
		return (
			<Container>
				<div className="py-8">
	...
	return (
		<Container>
			<div className="py-8">
				<div className="mb-6">
					<Breadcrumb>
						<BreadcrumbList>
							...
							<BreadcrumbSeparator />
							<BreadcrumbItem>
								<BreadcrumbPage>{component.name} Analytics</BreadcrumbPage>
							</BreadcrumbItem>
						</BreadcrumbList>
					</Breadcrumb>
				</div>
				...
				<PageTitle
					title={`${component.name} Analytics`}
					...
					<Card>
						...
						<CardContent className="py-8 text-center">
							<p className="text-muted-foreground">
								...
								appear here once users start interacting with this component.
							</p>
						</CardContent>
					</Card>
				)}
