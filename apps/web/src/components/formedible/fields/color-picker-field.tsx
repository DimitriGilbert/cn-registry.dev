	...
	return (
		<FieldWrapper fieldApi={fieldApi} {...wrapperProps}>
			<div className="relative space-y-2" ref={containerRef}>
				...
				{isOpen && (
					<div className="absolute z-50 mt-1 w-64 rounded-md border bg-popover p-4 shadow-lg">
						{/* Preset colors */}
						<div className="mb-4">
							<h4 className="mb-2 font-medium text-sm">Preset Colors</h4>
						...
						{allowCustom && (
							<div>
								<h4 className="mb-2 font-medium text-sm">Custom Color</h4>
								<div className="flex gap-2">
									<Input
										value={customInput}
