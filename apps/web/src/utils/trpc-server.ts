...
export const serverCaller = {
	components: {
		getAll: (
			input?: RouterInputs["components"]["getAll"],
		): Promise<RouterOutputs["components"]["getAll"]> =>
			fetchFromTRPC("components.getAll", input) as Promise<
				RouterOutputs["components"]["getAll"]
			>,
		getById: (
			input: RouterInputs["components"]["getById"],
		): Promise<RouterOutputs["components"]["getById"]> =>
			fetchFromTRPC("components.getById", input) as Promise<
				RouterOutputs["components"]["getById"]
			>,
	},
	tools: {
		getAll: (
			input?: RouterInputs["tools"]["getAll"],
		): Promise<RouterOutputs["tools"]["getAll"]> =>
			fetchFromTRPC("tools.getAll", input) as Promise<
				RouterOutputs["tools"]["getAll"]
			>,
		getById: (
			input: RouterInputs["tools"]["getById"],
		): Promise<RouterOutputs["tools"]["getById"]> =>
			fetchFromTRPC("tools.getById", input) as Promise<
				RouterOutputs["tools"]["getById"]
			>,
	},
	creators: {
		search: (
			input?: RouterInputs["creators"]["search"],
		): Promise<RouterOutputs["creators"]["search"]> =>
			fetchFromTRPC("creators.search", input) as Promise<
				RouterOutputs["creators"]["search"]
			>,
		getTrending: (
			input?: RouterInputs["creators"]["getTrending"],
		): Promise<RouterOutputs["creators"]["getTrending"]> =>
			fetchFromTRPC("creators.getTrending", input) as Promise<
				RouterOutputs["creators"]["getTrending"]
			>,
		getByUsername: (
			input: RouterInputs["creators"]["getByUsername"],
		): Promise<RouterOutputs["creators"]["getByUsername"]> =>
			fetchFromTRPC("creators.getByUsername", input) as Promise<
				RouterOutputs["creators"]["getByUsername"]
			>,
	},
	categories: {
		getAll: (): Promise<RouterOutputs["categories"]["getAll"]> =>
			fetchFromTRPC("categories.getAll") as Promise<
				RouterOutputs["categories"]["getAll"]
			>,
	},
	projects: {
		getBySlug: (
			input: RouterInputs["projects"]["getBySlug"],
		): Promise<RouterOutputs["projects"]["getBySlug"]> =>
			fetchFromTRPC("projects.getBySlug", input) as Promise<
				RouterOutputs["projects"]["getBySlug"]
			>,
	},
};
